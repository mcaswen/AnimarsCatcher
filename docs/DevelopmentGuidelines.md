...
| [06 命名整改记录](06_NamingMigration.md) | 本次存量命名迁移范围、验证结果、保留例外和后续任务 |
...
项目自有业务 C# 源码注释率必须大于等于 **15%**，推荐维持在 **17% 左右**。注释正文统一使用中文，API 和类型名等必要技术名称可以保留英文，正文结尾不使用中文句号或英文句号。详细计算范围、例外和防止无意义注释的要求见 [代码、DOTS 与 NetCode 规范](02_CodeArchitecture.md#42-注释率)。
