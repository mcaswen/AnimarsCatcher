...
- [项目架构总览](Architecture/README.md) 位于 `Architecture`，按 01～15 的连续编号描述当前模块、ECS、NetCode、关键链路、迁移记录和 Navigation 重构结果
...
3. 修改 Navigation 时，先看 08～10 的功能阶段，再看 14～15 的现行结构与 R1～R6 执行结果
