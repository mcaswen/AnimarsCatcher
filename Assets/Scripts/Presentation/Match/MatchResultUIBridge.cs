...
namespace AnimarsCatcher.Presentation.Match
{
    ...
    /// </summary>
    public static class MatchResultUIBridge
    {
        /// <summary>
        /// 把客户端胜负结果转交给当前场景中的结算面板
        /// </summary>
        /// <param name="isWin">本地玩家是否获胜</param>
        public static void ShowMatchResult(bool isWin)
        {
            ...
            {
                Debug.LogWarning("[MatchResultUIBridge] No GameResultPanelController instance in scene");
            }
        }
    }
}
