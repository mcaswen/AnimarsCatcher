...
namespace AnimarsCatcher.Presentation.HealthBars
{
    ...
    public class HealthBarView : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("rootRectTransform")]
        [SerializeField] private RectTransform _rootRectTransform;
        [FormerlySerializedAs("foregroundImage")]
            ...
            bool isFriendly)
        {
            ...
            {
                _foregroundImage.color = isFriendly ? Color.green : Color.red;
            }
        ...
        private void LateUpdate()
        {
            ...
            if (!_rootRectTransform.gameObject.activeSelf)
            {
            ...
            _rootRectTransform.anchoredPosition = uiPosition;
            ...
            if (_entityManager.HasComponent<Health>(_targetEntity))
            {
                ...
                if (health.Maximum > 0)
                {
                    healthPercent = math.clamp((float)health.Current / health.Maximum, 0f, 1f);
                }

                if (_foregroundImage != null)
                {
                    _foregroundImage.fillAmount = healthPercent;
                }
            }
        }
    }
