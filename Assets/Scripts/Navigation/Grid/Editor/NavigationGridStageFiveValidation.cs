...
namespace AnimarsCatcher.Navigation.Grid.Editor
{
    ...
    public static class NavigationGridStageFiveValidation
    {
        ...
        private static void TestMinimumCostAssignment()
        {
            ...
            Assert(
                AniSquadMovementAlgorithms.TrySolveMinimumCostAssignment(
                    costs,
                    3,
                    3,
                    first),
        ...
        {
            Assert(
                AniSquadMovementAlgorithms.CalculateAdaptiveColumnCount(
            ...
            Assert(
                AniSquadMovementAlgorithms.CalculateSlotRole(0, 6, 2) == AniSquadRole.Picker,
                "Front row should prefer Picker");
            Assert(
                AniSquadMovementAlgorithms.CalculateSlotRole(4, 6, 2) == AniSquadRole.Blaster,
