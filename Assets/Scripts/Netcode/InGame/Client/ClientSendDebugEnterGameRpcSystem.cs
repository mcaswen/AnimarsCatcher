namespace AnimarsCatcher.Networking
{
    ...
    public partial struct ClientSendDebugEnterGameRpcSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            state.EntityManager.AddComponentData(rpcEntity, new DebugEnterGameRpc());
            ...
            UnityEngine.Debug.Log(
                "[Client][Editor SCN_GameLevel] Auto sent DebugEnterGameRpc and marked InGame locally");
        }
    }
}
