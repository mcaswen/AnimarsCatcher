...
/// <summary>标记服务器已为连接创建角色，防止重复生成</summary>
public struct PlayerSpawnedTag : IComponentData {}

/// <summary>封装服务器对连接实体的 InGame、生成去重和 CommandTarget 操作</summary>
public readonly partial struct ServerGetConnectionAspect : IAspect
{
    ...
    /// <summary>确保连接带有 NetworkStreamInGame 标记</summary>
    ...
    /// <summary>判断服务器是否已为该连接创建角色</summary>
    /// <param name="state">服务器系统状态</param>
    ...
    /// <summary>将连接的输入命令目标设置为服务器创建的角色</summary>
