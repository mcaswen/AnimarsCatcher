    ...
    public partial struct ServerStartMatchSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            foreach (var (startGameRpc, source, rpcEntity) in SystemAPI
                        .Query<RefRO<StartMatchRequestRpc>, RefRO<ReceiveRpcCommandRequest>>()
                        .WithEntityAccess())
            {
            ...
            if (matchStateRW.ValueRO.ClientStartRpcSent == 0)
            {
                            ...
                            .WithEntityAccess())
                {
                    ...
                    entityCommandBuffer.AddComponent(rpcEntity, new StartMatchNotificationRpc
                    {
                        SceneName = sceneName
                    });
                    ...
                    UnityEngine.Debug.Log($"[Server] Send StartMatchNotificationRpc to connection {networkId.ValueRO.Value}.");
                }
