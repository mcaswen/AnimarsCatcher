    ...
    public partial struct ServerHandleDebugEnterGameRpcSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            bool hasCharacterPrefab =
                SystemAPI.TryGetSingleton(out CharacterGhostPrefabReference characterPrefab);
            bool hasCameraPrefab =
                SystemAPI.TryGetSingleton(out CameraGhostPrefabReference cameraPrefab);
            ...
            foreach (var (request, source, rpcEntity) in SystemAPI
                         .Query<RefRO<DebugEnterGameRpc>, RefRO<ReceiveRpcCommandRequest>>()
                         .WithEntityAccess())
            {
                ...
                Debug.Log("[ServerHandleDebugEnterGameRpcSystem] DebugEnterGameRpc received");
                             ...
                             DynamicBuffer<CharacterSpawnPointElement>>())
                {
                    ...
                    {
                        Debug.Log(
                            "[ServerHandleDebugEnterGameRpcSystem] Character already spawned for this connection, skip");
                    ...
                    entityCommandBuffer.DestroyEntity(rpcEntity);
                    Debug.Log(
                        $"[ServerHandleDebugEnterGameRpcSystem] Spawned character for connection {networkId} at {spawnPosition}");
                }
            }
